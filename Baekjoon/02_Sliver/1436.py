...
num = 666                 # 처음 수 666 
while count < N:          # 반복분
    if '666' in str(num): # 666이라는 단어가 num에 있다면 
        count += 1        # count + 1
    num += 1              # 그후 num+1 해서 숫자를 늘려간다.

print(num-1)              # 마지막 반복문을 돌면 +1 되서 나오니깐 -1 해준다.

# 666 1666~ 3666 4666 5666 6660~ 6669 7666 8666 9666
